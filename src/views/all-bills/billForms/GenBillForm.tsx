    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                const categoryOpts = categoryData?.data?.categories?.map((category: any) => ({
                    label: category.name,
                    value: category._id
                }))
            ...
            onSubmit={async (values, { setSubmitting, setErrors }) => {
                try {
                    ...
                    attachmentFiles.forEach((file, index) => {
                        ...
                        } else if (typeof file === 'string' && type === 'edit') {
                            ...
                            <div className="lg:col-span-2">
                                <AdaptableCard divider className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <FormItem
                                            label="Bill Type"
                                            invalid={!!errors.billType && touched.billType}
                                            errorMessage={errors.billType as string}
                                        >
                                            <Field name="billType">
                                        ...
                                        <FormItem
                                            ...
                                            errorMessage={errors.billDate as string}
                                        >
                                            <Field name="billDate">
                                                {({ field, form }: FieldProps) => (
                                                    <DatePicker
                                ...
                                <AdaptableCard divider className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <FormItem
                                            ...
                                            errorMessage={errors.invoiceNo as string}
                                        >
